...
#python evaluate.py --model=checkpoints/FlowDiffuser-things.pth  --dataset=sintel
python evaluate.py --model=checkpoints/FlowDiffuser-things.pth  --dataset=kitti --output_path="results/modelzoo-T"
#python evaluate.py --model=checkpoints/FlowDiffuser-things.pth  --dataset=chairs