...
CUDA_VISIBLE_DEVICES=4,5  python -u train.py --name fd-aft-sintel --stage sintel --validation sintel kitti --restore_ckpt checkpoints/FlowDiffuser-things.pth --gpus 0 1 --num_steps 540000 --batch_size 2 --lr 0.000175 --image_size 432 960 --wdecay 0.00001 --gamma=0.85 --mixed_precision