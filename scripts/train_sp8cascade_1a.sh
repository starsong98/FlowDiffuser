...
# 12-iter no cascade ver.
#CUDA_VISIBLE_DEVICES=4  python -u train_gradacc.py --name fd_nocascade_12iter-chairs --stage chairs --validation chairs \
#--gpus 0 --num_steps 100000 --val_freq 5000 --batch_size 6 --effective_batch_size 12 --lr 0.00045 \
#--image_size 368 496 --wdecay 0.0001 --iters 12 --sampling_timesteps 4 \
#--model_type flowdiffuser_nocascade_adjustable

# 1/8 scale cascade refinement ver. - each 6 iters.
CUDA_VISIBLE_DEVICES=5  python -u train_gradacc.py --name fd_sp8cascade_6iter_6itercr-chairs --stage chairs --validation chairs \
--gpus 0 --num_steps 100000 --val_freq 5000 --batch_size 6 --effective_batch_size 12 --lr 0.00045 \
--image_size 368 496 --wdecay 0.0001 --iters 6 --iters_cascade 6 --sampling_timesteps 4 \
--model_type flowdiffuser_sp8cascade_adjustable