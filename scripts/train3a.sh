...
CUDA_VISIBLE_DEVICES=0  python -u train.py --name fd-autoflow0 --stage autoflow_cross --validation autoflow --gpus 0 --num_steps 100000 --batch_size 1 --lr 0.0004 --image_size 384 512 --wdecay 0.0001