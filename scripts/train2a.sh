...
CUDA_VISIBLE_DEVICES=0,1  python -u train.py --name fd-sintel --stage sintel --validation sintel --restore_ckpt checkpoints/FlowDiffuser-things.pth --gpus 0 1 --num_steps 180000 --batch_size 2 --lr 0.000175 --image_size 432 960 --wdecay 0.00001 --gamma=0.85 --mixed_precision